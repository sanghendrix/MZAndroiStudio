...
class MainActivity : AppCompatActivity(), BillingProcessor.IBillingHandler {
    ...
    private suspend fun checkForAppUpdate() {
        val updateUrl = "https://github.com/sanghendrix/MZAndroiStudio/raw/main/samomorupdate.txt"
        val latestVersionName = withContext(Dispatchers.IO) {
            try {
        ...
        if (currentVersionName.isNotEmpty() && latestVersionName.isNotEmpty() && currentVersionName != latestVersionName) {
            showUpdateDialog()
        }
    }
    ...
    private fun showUpdateDialog() {
        ...
        builder.setTitle("Game Update")
        builder.setMessage("A new version is now available on Play Store. Please update before play!")

        builder.setPositiveButton("Update") { _, _ ->
            val intent = Intent(Intent.ACTION_VIEW).apply {
                data = Uri.parse("https://play.google.com/store/apps/details?id=com.sanghendrix.intosamomor")
